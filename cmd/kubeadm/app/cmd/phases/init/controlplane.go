...
var (
	controlPlaneExample = cmdutil.Examples(`
		# Generates all static Pod manifest files or service unit files for control plane components,
		# functionally equivalent to what is generated by kubeadm init.
		kubeadm init phase control-plane all

		# Generates all static Pod manifest or service unit files using options read from a configuration file.
...
func getPhaseDescription(component string) string {
	return fmt.Sprintf("Generates the %s static Pod manifest or service unit files", component)
}
...
func NewControlPlanePhase() workflow.Phase {
	phase := workflow.Phase{
		Name:  "control-plane",
		Short: "Generate all static Pod manifest or service unit files necessary to establish the control plane",
	...
	return func(c workflow.RunData) error {
		...
		if data.ServiceHosting() {
			...
			if data.DryRun() {
				...
				return controlplane.RunServices(component)
			}
